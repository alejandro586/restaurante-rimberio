...
/*
 * En la tabla mostramos como máximo
...
/*
 * Para construir gráficos podemos pedir
 * más filas sin renderizarlas todas
 * en la tabla.
 *
 * Si un dataset tiene menos de 5000 filas,
 * los gráficos usarán todas.
 *
 * Si tiene más, se utilizarán las primeras
 * 5000 y se mostrará un aviso.
 */
const FILAS_GRAFICO_MAX =
  5000
 ...
 * "28,25"
 *
 * en números utilizables para gráficos.
 */
const aNumero =
  (
    valor
     ...
     * Tiene coma y punto.
     *
     * Determinamos cuál parece ser
     * el separador decimal por la
...
const detectarColumnas =
  (
    ...
    for (
      ...
      /*
       * Una columna se considera numérica
       * cuando al menos 70 % de sus valores
       * pueden convertirse correctamente.
       */
      if (
        porcentaje >=
        0.7
...
const construirSerie =
  (
    ...
    /*
     * Si no hay una dimensión textual,
     * utilizamos el número de fila.
     */
    if (
      dimension ===
      "__fila__"
            ...
            return (
              ...
              <div
                ...
                style={{
                  ...
                  gridTemplateColumns:
                    "minmax(110px, 180px) 1fr minmax(80px, auto)",
...
const PanelGraficos =
  ({
    ...
    /*
     * Si cambia el dataset,
     * aseguramos que la selección
     * siga siendo válida.
     */
    useEffect(
      () => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          {parcial
            ? `Este dataset tiene ${miles(
                totalFilas
              )} filas. Los gráficos se calculan con las primeras ${miles(
                filas.length
        ...
        >
          ...
          >
            Suma de la métrica seleccionada para cada grupo.
          </p>
        ...
        >
          ...
          <div className="chart-title">
            ...
            {esTemporal(
              ...
              ? `Evolución de ${metrica}`
              : `Comportamiento de ${metrica}`}
          ...
          >
            ...
            {esTemporal(
              ...
              ? `Evolución según ${dimension}.`
              : `Representación visual de los grupos principales según ${dimension}.`}
  ...
  () => {
    ...
    const abrir =
      async (
        ...
        /*
         * Cargamos suficientes filas para
         * construir gráficos útiles.
         *
         * La tabla seguirá mostrando solo
         * las primeras 100.
         */
        const total =
          Number(
                ...
                "datos" && (
                  ...
                  <>
                    ...
                    >
                      ...
                      filas del archivo, con sus columnas originales.
